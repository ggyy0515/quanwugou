...
@property (nonatomic, njk_weak) UIWebView *webView;
@property (nonatomic, njk_weak) NSURLConnection *urlConnection;
@property (nonatomic, njk_weak) NSURLRequest *request;
