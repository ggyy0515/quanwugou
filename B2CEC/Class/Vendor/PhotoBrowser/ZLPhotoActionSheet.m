...
- (instancetype)init
{
    ...
    if (self) {
        self.frame = CGRectMake(0, -64, kViewWidth, kViewHeight);//by Tristan 这些东东可以根据项目调整
...
- (void)presentVC:(UIViewController *)vc
{
    ...
    [nav.navigationBar setBackgroundImage:[self imageWithColor:[UIColor whiteColor]] forBarMetrics:UIBarMetricsDefault];
