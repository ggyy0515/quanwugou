...
- (void)initBottomView
{
    ...
    [_btnOriginalPhoto setTitleColor:MainColor forState: UIControlStateNormal];// by Tristan 只是修改颜色而已
    ...
    self.labPhotosBytes.textColor = LightMoreColor;// by Tristan 只是修改颜色而已
    ...
    [_btnDone setBackgroundColor:MainColor];// by Tristan 只是修改颜色而已
