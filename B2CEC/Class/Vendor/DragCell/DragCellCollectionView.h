...
/**长按多少秒触发拖动手势，默认0.25秒，如果设置为0，表示手指按下去立刻就触发拖动*/
@property (nonatomic, assign) NSTimeInterval minimumPressDuration;
/**是否正开始编辑模式*/
@property (nonatomic, assign) BOOL beginEditing;

@property (nonatomic,copy) void (^removeCellBlock)(NSIndexPath *indexPath);

@property (nonatomic,copy) void (^addCellBlock)(NSIndexPath *indexPath);
