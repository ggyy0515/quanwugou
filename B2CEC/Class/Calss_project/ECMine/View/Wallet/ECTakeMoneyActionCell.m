...
@interface ECTakeMoneyActionCell ()
...
@implementation ECTakeMoneyActionCell
...
- (void)setModel:(ECWalletInfoModel *)model {
    _model = model;
    NSMutableAttributedString *allTitle = [[NSMutableAttributedString alloc] initWithString:@"全部提现"
